function [tform, movingReg, rmse] = icp_profiling(moving, fixed, varargin)
...
%   disp(tform2.T);
%
% See also pointCloud, pcregisterndt, pcregistercpd, pctransform, affine3d, 
...
for i = 1 : maxIterations
    ...
    t5=clock;
    iter=[iter;etime(t4,t3),etime(t5,t4)];
end
...
t7=clock;
fin=etime(t7,t5);
totaltime=preload+fin+sum(sum(iter));
save profiling_result_200000.mat preload iter fin totaltime
end
